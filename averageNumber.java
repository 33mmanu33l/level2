...
public class averageNumber {
    ...
    /* Main Function
     Request input from user to provide integer numbers. find total of
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("Please enter an integer either positive or negetive: \n"
                    + "(When done enter 0 to start calculations)");
